...
class DefaultObject(ObjectDB, metaclass=TypeclassBase):
	...
	def announce_move_from(self, destination, msg=None, mapping=None, **kwargs):
		...
		if msg:
			...
			if self.db.specialleavemsg:
				string = "|/" + self.key + " " + self.db.specialleavemsg
			else:
				string = "{object} is leaving."
#			string = "{object} is leaving {origin}, heading for {destination}."
	...
	def announce_move_to(self, source_location, msg=None, mapping=None, **kwargs):
		...
		if source_location:
			if msg:
				string = msg
			if self.db.specialarrivemsg:
				string = "|/" + self.key + " " + self.db.specialarrivemsg
			else:
#				string = "{object} enters."
...
class DefaultCharacter(DefaultObject):
	...
	def at_after_move(self, source_location, **kwargs):
		...
		"""
		if self.location.tags.get("autofight"):
			pass
		else:
